;;; svg+.el --- Extended SVG image creation functions -*- lexical-binding: t -*-

;; Copyright (C) 2016-2018 Felix E. Klee <felix.klee@inka.de>, Free
...
;; Version: 0.1.0
;; Keywords: image
;; URL: https://github.com/feklee/svg+
...
;; This package is based on the package `svg.el' originally written by
;; Lars Magne Ingebrigtsen <larsi@gnus.org> and included in Emacs
;; 26.1.  `svg+.el' provides additional SVG editing functions.
